            ...
            .authorizeHttpRequests(
                    req ->
                            req.requestMatchers(CUSTOM_JWT_WHITE_LIST)
                                    ...
                                    .permitAll()
                                    .requestMatchers(GET, "/api/v1/books/**")
                                    .permitAll()
                                    .requestMatchers(POST, "/api/v1/books/**")
                                    .authenticated()
                                    .requestMatchers("/api/v1/management/**")
                                    .hasAnyRole(ADMIN.name(), MANAGER.name())
                                    .requestMatchers(GET, "/api/v1/management/**")
                                    .hasAnyAuthority(ADMIN_READ.getPermission(), MANAGER_READ.getPermission())
                                    ...
                                    .hasAnyAuthority(ADMIN_UPDATE.getPermission(), MANAGER_UPDATE.getPermission())
                                    .requestMatchers(DELETE, "/api/v1/management/**")
                                    .hasAnyAuthority(ADMIN_DELETE.getPermission(), MANAGER_DELETE.getPermission())
                                    .anyRequest()
                                    .authenticated())
